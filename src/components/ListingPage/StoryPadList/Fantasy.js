        ...
        <div className="container">
          <div className="card-columns">

            {
              ...
              storyData !== undefined && storyData.map((e) => {

                if (e !== undefined && e.category == "uiux") {
                        ...
                        <div className="card-body">
...

                          {
                            ...
                            <Link
                                ...
                                <Button style={{backgroundColor: '#6EBF8B', color: '#151D3B'}} disabled={false} variant="outline-info btn-outline-danger buy-story-btn">Get started</Button>
                              </Link>

                              :
                              <Link
                                to={`/fantasy-detail/${e.id}`}>
                                <Button style={{backgroundColor: '#6EBF8B', color: '#151D3B'}} variant="outline-info btn-outline-danger buy-story-btn" disabled={false} >Get started</Button>
                              </Link>
                          }
                        </div>
                      </a>
