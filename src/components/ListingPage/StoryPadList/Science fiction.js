      ...
      <div style={{ marginTop: "100px" }} className="container footer-top">
        ...
        <div className="container">
          <div className="card-columns">
            ...
            {storyData !== undefined &&
              storyData.map((e) => {
                if (e !== undefined && e.category == "web3fundamentals") {
                  return (
                        ...
                        <div className="card-body">
...

                          {
                            ...
                            <Link
                              ...
                              <Button disabled={false} variant="outline-info btn-outline-danger buy-story-btn">Get started</Button>
                              </Link>

                              :
                              <Link
                                to={`/sciencefiction-detail/${e.id}`}>
                                <Button variant="outline-info btn-outline-danger buy-story-btn" disabled={false} >Get started</Button>
                              </Link>
                          }
                        </div>
                      </a>
