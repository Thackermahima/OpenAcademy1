  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        {/* Category List */}
        <Route path="/UIandUX" element={<Fantasy />} />
        <Route path="/Cryptocurrency" element={<Historical />} />
        <Route path="/smartcontract" element={<Horror />} />
        <Route path="/Blockchain" element={<Mystery />} />
        <Route path="/newadult" element={<NewAdult />} />
        <Route path="/paranomal" element={<Paranormal />} />
        <Route path="/Defi" element={<Romance />} />
        <Route path="/web3" element={<ScienceFiction />} />
